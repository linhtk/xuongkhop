...
$xtpl = new XTemplate("templates/xuongkhop.html");
///tin tuc
...
if ($id != '') {
    ...
    $sql_tin = "SELECT md5(news_id) AS news_id, news_title, news_brief, news_image FROM tg_news_cate WHERE cate_id IN (121, 122, 123, 124) ORDER BY news_id ASC";
}
