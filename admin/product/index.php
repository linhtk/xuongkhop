<?php
	...
	for($i=0;$i<count($array);$i++)
	{
		...
		{
			if (file_exists("../upload/products/".$array[$i]['product_image']))
			{
				$array[$i]['product_image'] = '<a href="#" onclick="openwin(\'image_viewer.php?path=products&img='.$array[$i]['product_image'].'\');">'.COM_VIEW_IMAGE.'</a>';
			} else 
			{
